[![Build Status](https://dev.azure.com/wacrenieremilien/FirstPipeline/_apis/build/status/Nieleim.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/wacrenieremilien/FirstPipeline/_build/latest?definitionId=1&branchName=master)
